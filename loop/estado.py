...
serverSocket.bind(("127.0.0.1", 9090)); #Se asigna un puerto libre para el socket
serverSocket.listen();
...
while True:
    ...
    if conexion1 == conexion2:
        ...
        estadoConexion="Conexión establecida"


    clientConnected.send(estadoConexion.encode()); #Envio de información al cliente (main.py)